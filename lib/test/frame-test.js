...
describe('Frame Model', function() {
  ...
  it('should new frame set roll1 and roll2 by default', () => {
    frame = new Frame();
    frame.roll1.should.eql(0);
    frame.roll2.should.eql(0);
  });

  it('should new frame have no bonus points', () => {
    frame = new Frame(9, 1);
    frame.bonusPoints.should.eql(0);
  });
  ...
  it('should getScore return roll sum and bonus points', () => {
    frame = new Frame(1, 5);
    frame.bonusPoints = 1;
    frame.getScore().should.eql(7);
  })
});
