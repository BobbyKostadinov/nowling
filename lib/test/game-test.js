...
describe('Game Model', function() {
  ...
  it('should have not call updateBonusScore if frame is "strike"', () => {
    frame.type = 'strike';
    game.updateBonusScore = spy();
    game.addFrame(1, 1);
    game.updateBonusScore.calledOnce.should.eql(true);
  });

  it('should have not call updateBonusScore if frame is "spare"', () => {
    Frame = (roll1, roll2) => {
      return { roll1: 1, roll2: 1, bonusPoints: 0, type: 'spare' };
    };
    game.updateBonusScore = spy();
    game.addFrame(1, 1);
    game.updateBonusScore.calledOnce.should.eql(true);
  ...
  it('should getFrame return frame 2 - index 1 in the game object array', () => {
    ...
    (result.roll1 === null).should.eql(true);
  });
