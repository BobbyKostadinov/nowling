...
describe('Game Model', function() {
  ...
  it('should have method getCurrentTotalScore', () => {
    (typeof game.getCurrentTotalScore === 'function').should.eql(true);
  });
  ...
  it('should updateBonusScore backtrack to set bonus when first roll was a strike with 3 frames', () => {
    game.addFrame(10, 0);
    game.addFrame(1, 0);
    game.addFrame(1, 0);

    // Mocking is not presice due to hardcoded frame added, but we expect to combine roll1 of both 2 and 3 frame due to 2 being strike
    game.frames[0].bonusPoints.should.eql(3);
  });
