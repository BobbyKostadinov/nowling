...
class Game {
  ...
  getCurrentTotalScore() {
    // Calculate total score by adding each individual frame score from frames 1-10
    // Frame 11 is a bonus and as such has been computed into the bonusScore of frame 10 and should be ignored
  }
